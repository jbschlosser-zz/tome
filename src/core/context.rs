...
pub struct Context<'a> {
    ...
    pub bindings: HashMap<Vec<u8>, Rc<Box<Fn(&mut Session) -> bool + 'a>>>,
...
impl<'a> Context<'a> {
    ...
    pub fn bind_key<F: Fn(&mut Session) -> bool + 'a>(&mut self,
        key_name: &str, func: F)
    {
    ...
    pub fn bind_keycode<F: Fn(&mut Session) -> bool + 'a>(&mut self,
